INSERT INTO vets VALUES (1, 'James', 'Carter', '1', 'james.carter@petclinic.com') ON CONFLICT DO NOTHING;
INSERT INTO vets VALUES (2, 'Helen', 'Leary', '2', 'helen.leary@petclinic.com') ON CONFLICT DO NOTHING;
INSERT INTO vets VALUES (3, 'Linda', 'Douglas', '3', 'linda.douglas@petclinic.com') ON CONFLICT DO NOTHING;
INSERT INTO vets VALUES (4, 'Rafael', 'Ortega', '4', 'rafael.ortega@petclinic.com') ON CONFLICT DO NOTHING;
INSERT INTO vets VALUES (5, 'Henry', 'Stevens', '5', 'henry.stevens@petclinic.com') ON CONFLICT DO NOTHING;
INSERT INTO vets VALUES (6, 'Sharon', 'Jenkins', '6', 'sharon.jenkins@petclinic.com') ON CONFLICT DO NOTHING;
