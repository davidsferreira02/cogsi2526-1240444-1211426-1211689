...
public class JdbcOwnerRepositoryImpl implements OwnerRepository {
     ...
     * owners whose last name <i>starts</i> with
     * the given name; also loads the {@link Pet Pets} and {@link Visit Visits} for
     * the corresponding owners, if not
     * already loaded.
     */
    @Override
    ...
    /**
     * Loads the {@link Owner} with the supplied <code>nif</code>; also loads the
     * {@link Pet Pets} and {@link Visit Visits}
     * for the corresponding owner, if not already loaded.
     */
    @Override
    ...
    public void loadPetsAndVisits(final Owner owner) {
        final List<JdbcPet> pets = this.jdbcClient
                .sql("""
